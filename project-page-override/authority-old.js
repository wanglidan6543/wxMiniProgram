...
Authority.prototype.getConfigResult = function(identify, page, data) {
...
Authority.prototype.getAuthority = function(identify, page, data) {
  if (!identify || identify.length === 0) {
    return false;
  }
  if (!page || page.length === 0) {
...
Authority.prototype.updateAuthority = function() {
